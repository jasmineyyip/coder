    ...
    <div className="fixed inset-0 flex flex-col bg-slate-900">
      ...
      <div className="flex-shrink-0 flex items-center justify-start gap-4 px-4 py-4 bg-slate-900/90 border-t border-slate-700">
        <button
          type="button"
          onClick={takePhoto}
          className="flex items-center justify-center w-36 h-36 rounded-full bg-red-600 text-white active:bg-red-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
          aria-label="Take photo"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-20 h-20" aria-hidden>
